	...
	*/
	...
	FLOAT_SEND_OVERLAY.prototype = 
	{
		create : function()
		{
			...
			overlayFakeContainer.innerHTML = '<style id="FLOAT_SEND_STYLE">'+styles+'</style>' + sendoverlay;
		...
		{
			this.toggleClass( document.getElementById('FLOAT_SEND_OVERLAY_WRAPPER'), 'PKT_SHOW_INPUT', false);
		...
		{
			var self = this;
			this.displayMessage("Link didn't send to your friends, Please check your network!");
		...
		saveTags : function()
		{
			...
			var tagsList = this.trim(document.getElementById('FLOAT_SEND_OVERLAY_INPUT').value);
		...
		{
			this.toggleClass( document.getElementById('FLOAT_SEND_OVERLAY_WRAPPER'), 'PKT_SHOW_INPUT', true);
	...
	FLOAT_SEND.prototype = 
	{
		...
		send : function()
		{
			...
			this.sendoverlay.displayMessage("Current link is sending to your friends");
			var self = this;
